...
var tabSwitchEventHandler = null;
...
function setTabListeners(callback) {
    document.onkeydown = function(e) {
        ...
        if(activeElement.classList.tagName != 'input' && !activeElement.classList.contains("slds-checkbox_faux")) {
        ...
        if(typeof(callback) === 'function' && (e.keyCode === rightArrowCode || e.keyCode === leftArrowCode)) {
            callback();
        }
    }
}
